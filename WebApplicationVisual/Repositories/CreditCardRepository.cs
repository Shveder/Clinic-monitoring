...
public class CreditCardRepository : RepositoryBase
{
    ...
    {
        var sql = "INSERT INTO dentist.cards (card_number, name, date, cvv, user_id) " +
    ...
    {
        using var connection = new NpgsqlConnection(connectionString);
        var sql = "DELETE FROM dentist.cards WHERE id = @id";
        using var command = new NpgsqlCommand(sql, connection);
    ...
    public List<string> GetNumberOfCardsOfUser(int id)
    {
        ...
        var sql = "SELECT card_number FROM dentist.cards WHERE user_id = @id";
    ...
    {
        NpgsqlConnection connection = new NpgsqlConnection(connectionString);
        var sql = "SELECT * FROM dentist.cards WHERE user_id = @id";
    ...
    public bool HasCards(int id)
    {
        ...
        {
            var sql = "SELECT COUNT(*) FROM dentist.cards WHERE user_id = @userId";
